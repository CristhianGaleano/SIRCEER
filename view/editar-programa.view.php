...
<div class="formulario-editar-user">
	...
	<div class="row">
		<div class="col-md-4">
			<div class="form-group">
				<label class="col-form-label" for="snies">SNIES</label>
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<label class="col-form-label" for="valor_semestre">Valor semestre</label>
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="form-group">
				<label class="col-form-label" for="universidad">Universidad</label>
